...
public class ACPCore_Cordova extends CordovaPlugin {
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        // Read AppId from AndroidManifest meta-data
        try {
            ...
            appId = ai.metaData.getString("com.adobe.AppId");
            Log.d("ACP_CORE", "AppId loaded: " + appId);
        } catch (PackageManager.NameNotFoundException e) {
            Log.e("ACP_CORE", "Failed to read AppId from AndroidManifest: " + e.getMessage());
            appId = "";
        }
        ...
        try {
            ...
            Log.e("ACP_CORE", "Erro ao inicializar o SDK: " + e.getMessage());
        }
